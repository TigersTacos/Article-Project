...
//date: feb 9 2026
//description: this is a completion/update of the semi-complete ArticleList class, adding a lot of stuff.
...
public class ArticleList {
	...
	// method: removeAuthor
	// description: This method removes all articles written by a certain author, defaulting to Anne Demoulin;
		//Nothing really against her, it's just she writes in French and I don't speak french.
	// parameters: String author, the author is set by user.
	// return: No return, but will be evident in the toString/what the user sees.
	...
	// method: findKeyWord
	// description: Creates and returns an array containing all articles that contain a specific keyword in the title.
	// parameters: String word, the word it looks for.
	// return: Returns the array containing all articles with a certain word in the title.
	...
	// method: getArticles
	// description: Basically the same as findKeyWord, but with authors. Creates + returns arrayList with all articles by a certain author
	// parameters: String author - the author its looking for.
	// return: Returns the aforementioned ArrayList
...
//	         shown below.
	...
	// method: buildDate
	// description: Initializes and creates all the date stuff to get it to "work"
	// parameters: N/A
	// return: cal.getTime();.
	...
	// method: Basically the constructor but put elsewhere for ease and whatnot.
	// description: Reads through something - api i think (they really didn't tell me this) and does something
	// parameters: n/a
	// return: n/a
	private void fetchArticles() {
	    ...
	    ArticleGetter a = new ArticleGetter(topic, "api key here");
